...
@Component({
  selector: 'app-staffingprofile',
  templateUrl: './staffingprofile.component.html',
  styleUrls: ['./staffingprofile.component.scss']
})
export class StaffingprofileComponent implements OnInit {
  user_id: string;
  name: any;
  email: any;
  role: any;
